 ...
 * Only change: removed `import { Notice } from 'obsidian'` — notices are
 * now emitted via the `onNotice` callback injected at construction time.
 */
